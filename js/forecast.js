 ...
 <div class="hightemp" id="hi2" style="
margin-left: 181px;
">${calendarDayTemperatureMax[2]}</div>
 <div class="hightemp" id="hi3" style="
margin-left: 275px;
">${calendarDayTemperatureMax[3]}</div>
 <div class="hightemp" id="hi4" style="
margin-left: 367px;
">${calendarDayTemperatureMax[4]}</div>
 <div class="hightemp" id="hi5" style="
margin-left: 457px;
">${calendarDayTemperatureMax[5]}</div>
 <div class="hightemp" id="hi6" style="
margin-left: 546px;
">${calendarDayTemperatureMax[6]}</div>`
document.getElementById('lowtemps').innerHTML = `                   <div class="lowtemp" id="lo0">${calendarDayTemperatureMin[0]}</div>
<div class="lowtemp" id="lo1" style="margin-left: 93px;">${calendarDayTemperatureMin[1]}</div>
<div class="lowtemp" id="lo2" style="
margin-left: 181px;
">${calendarDayTemperatureMin[2]}</div>
<div class="lowtemp" id="lo3" style="
margin-left: 275px;
">${calendarDayTemperatureMin[3]}</div>
<div class="lowtemp" id="lo4" style="
margin-left: 367px;
">${calendarDayTemperatureMin[4]}</div>
<div class="lowtemp" id="lo5" style="
margin-left: 457px;
">${calendarDayTemperatureMin[5]}</div>
<div class="lowtemp" id="lo6" style="
margin-left: 546px;
">${calendarDayTemperatureMin[6]}</div>`
  }
  FetchForecast();
